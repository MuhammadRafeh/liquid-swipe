...
const slides = [
  {
    ...
    picture: require("../assets/foods/1.png"),
  },
  {
    color: "#0090D6",
    title: "Healthy Foods",
    ...
    picture: require("../assets/foods/5.png"),
  },
  {
    color: "#69C743",
    ...
    picture: require("../assets/foods/4.png"),
  },
  {
    color: "#FB3A4D",
    title: "10000+ Recipes",
    ...
    picture: require("../assets/foods/2.png"),
  },
  {
    color: "#F2AD62",
    ...
    picture: require("../assets/foods/3.png"),
  },
];
